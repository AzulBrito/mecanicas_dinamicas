...
float b = 0;  
float c = 0;  
/*En este caso deje aplicada la reflexion*/
void setup() {
  size(400, 400);
}
...
los dejé en color negro*/
  stroke(0);
  line(width/2, 0, width/2, height);
  line(0, height/2, width, height/2);
  stroke(#FC0808);
  /* luego dibujo los puntos de la funcion cuadratica con el bucle "for" 
que va de izquierda a derecha y calcula cada valor de y correspondiente a sus valores en x con 
la formula de la funcion cuadratica*/
  float lastY = 0;
...
/* Tambien cree una linea que recorre los puntos para que sea
